...
public partial class UserDetailViewModel : INotifyPropertyChanged
{
    ...
    public UserDetailViewModel(AppDbContext context, INavigationService navigationService, IAuthenticationService authService)
    {
        ...
        SaveUserCommand = new AsyncRelayCommand(async () => await SaveUserAsync(), CanSaveUser);
        DeleteUserCommand = new AsyncRelayCommand(async () => await DeleteUserAsync(), CanDeleteUser);
        AddRoleCommand = new AsyncRelayCommand<RoleItem>(async (role) => await AddRoleAsync(role));
        RemoveRoleCommand = new AsyncRelayCommand<RoleItem>(async (role) => await RemoveRoleAsync(role));
        BackCommand = new AsyncRelayCommand(async () => await NavigateBackAsync());
    ...
    public IAsyncRelayCommand RemoveRoleCommand { get; }
