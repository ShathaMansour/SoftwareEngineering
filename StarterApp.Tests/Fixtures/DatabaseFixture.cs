...
public class DatabaseFixture : IDisposable
{
    ...
    {
        // Each fixture instance gets its own unique database — prevents
        // "key already added" errors when multiple test classes run in parallel
    ...
    {
        // Check if already seeded to prevent duplicate key errors on retry
